  ...
  const singleStoryData = [
    {
      title: "Bill Gates",
      img: "/bill_gates.jpg",
      postImg: "bg-[url(/story1.jpg)]",
    },
    {
      title: "Elon Musk",
      img: "/elon_musk.jpg",
      postImg: "bg-[url(/story2.jpg)]",
    },
    {
      title: "Tony Elumelu",
      img: "/Tony.jpg",
  ...
  return (
    <div className="px-4 bg-white rounded-[17px] shadow-md">
      ...
      <div className="flex gap-[10px] mt-5 pb-5 overflow-x-auto scrollbar-hide">
        <div className="w-[145px] shadow-md rounded-[15px] pb-2 shrink-0">
          <img
            className="w-[145px] h-[151px] rounded-t-[15px] object-cover"
